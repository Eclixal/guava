...
abstract class AbstractAggregateFutureStateI<OutputT> extends AbstractFutureI.TrustedFutureI<OutputT> {
  ...
  private static final Logger log = Logger.getLogger(AbstractAggregateFutureStateI.class.getName());
    ...
    try {
      helper =
          new SafeAtomicHelper(
              newUpdater(AbstractAggregateFutureStateI.class, (Class) Set.class, "seenExceptions"),
              newUpdater(AbstractAggregateFutureStateI.class, "remaining"));
  ...
  AbstractAggregateFutureStateI(int remainingFutures) {
  ...
  private abstract static class AtomicHelper {
    /** Atomic compare-and-set of the {@link AbstractAggregateFutureStateI#seenExceptions} field. */
    abstract void compareAndSetSeenExceptions(
            AbstractAggregateFutureStateI state, Set<Throwable> expect, Set<Throwable> update);

    /** Atomic decrement-and-get of the {@link AbstractAggregateFutureStateI#remaining} field. */
    abstract int decrementAndGetRemainingCount(AbstractAggregateFutureStateI state);
  }

  private static final class SafeAtomicHelper extends AtomicHelper {
    final AtomicReferenceFieldUpdater<AbstractAggregateFutureStateI, Set<Throwable>> seenExceptionsUpdater;

    final AtomicIntegerFieldUpdater<AbstractAggregateFutureStateI> remainingCountUpdater;
    ...
    @Override
    int decrementAndGetRemainingCount(AbstractAggregateFutureStateI state) {
