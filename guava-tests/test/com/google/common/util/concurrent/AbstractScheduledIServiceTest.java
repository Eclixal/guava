...
import static com.google.common.util.concurrent.AbstractScheduledIService.Scheduler.newFixedDelaySchedule;
import static com.google.common.util.concurrent.MoreExecutors.directExecutor;
import static java.util.concurrent.TimeUnit.SECONDS;

import com.google.common.util.concurrent.AbstractScheduledIService.Scheduler;
...
/**
 * Unit test for {@link AbstractScheduledIService}.
 *
 * @author Luke Sandberg
 */

public class AbstractScheduledIServiceTest extends TestCase {
  ...
  public void testServiceStartStop() throws Exception {
    NullIService service = new NullIService();
  ...
  private class NullIService extends AbstractScheduledIService {
    @Override
  ...
  public void testFailOnExceptionFromRun() throws Exception {
    TestIService service = new TestIService();
    ...
    assertEquals(IService.State.FAILED, service.state());
  }
  ...
  public void testDefaultExecutorIsShutdownWhenServiceIsStopped() throws Exception {
    ...
    AbstractScheduledIService service =
        new AbstractScheduledIService() {
          @Override
          protected void runOneIteration() throws Exception {}
  ...
  public void testTimeout() {
    ...
    try {
      IService.startAsync().awaitRunning(1, TimeUnit.MILLISECONDS);
  ...
  private class TestIService extends AbstractScheduledIService {
  ...
  public static class SchedulerTest extends TestCase {
    ...
    public void testFixedDelayScheduleFarFuturePotentiallyOverflowingScheduleIsNeverReached()
        throws Exception {
      TestAbstractScheduledCustomIService service =
          new TestAbstractScheduledCustomIService() {
            @Override
            protected Scheduler scheduler() {
    ...
    public void testCustomSchedulerFarFuturePotentiallyOverflowingScheduleIsNeverReached()
      ...
      TestAbstractScheduledCustomIService service =
          new TestAbstractScheduledCustomIService() {
            @Override
            protected Scheduler scheduler() {
              return new AbstractScheduledIService.CustomScheduler() {
                @Override
    ...
    private class TestCustomScheduler extends AbstractScheduledIService.CustomScheduler {
    ...
    public void testCustomSchedulerServiceStop() throws Exception {
      TestAbstractScheduledCustomIService service = new TestAbstractScheduledCustomIService();
      service.startAsync().awaitRunning();
    ...
    public void testCustomScheduler_deadlock() throws InterruptedException, BrokenBarrierException {
      ...
      for (int i = 0; i < 1000; i++) {
        ...
        IService.startAsync().awaitRunning();
        inGetNextSchedule.await();
        IService.stopAsync();
      }
    }
    ...
    private static class TestAbstractScheduledCustomIService extends AbstractScheduledIService {
    ...
    public void testCustomSchedulerFailure() throws Exception {
      TestFailingCustomScheduledIService service = new TestFailingCustomScheduledIService();
      service.startAsync().awaitRunning();
      for (int i = 1; i < 4; i++) {
        service.firstBarrier.await();
    ...
    private static class TestFailingCustomScheduledIService extends AbstractScheduledIService {
      final AtomicInteger numIterations = new AtomicInteger(0);
      final CyclicBarrier firstBarrier = new CyclicBarrier(2);
      final CyclicBarrier secondBarrier = new CyclicBarrier(2);
