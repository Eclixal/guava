...
/**
 * Unit test for {@link SimpleITimeLimiter}.
 *
 * @author kevinb
 * @author Jens Nyman
 */

public class SimpleITimeLimiterTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    super.setUp();
    service = SimpleITimeLimiter.create(executor);
  }
