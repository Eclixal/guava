...
/**
 * An {@link ExecutorService} that returns {@link IListenableFuture} instances. To create an instance
...
@GwtIncompatible
public interface IListeningExecutorService extends ExecutorService {
  /**
   * @return a {@code ListenableFuture} representing pending completion of the task
   * @throws RejectedExecutionException {@inheritDoc}
   */
  @Override
  <T> IListenableFuture<T> submit(Callable<T> task);
   ...
   */
  @Override
  IListenableFuture<?> submit(Runnable task);
   ...
   */
  @Override
  <T> IListenableFuture<T> submit(Runnable task, T result);

  /**
   * {@inheritDoc}
   *
   * <p>All elements in the returned list must be {@link IListenableFuture} instances. The easiest
