 ...
 * </ul>
 *
 * <p>There are deviations from this if there are failures or if {@link IService#stopAsync} is called
 * before the {@link IService} reaches the {@linkplain State#RUNNING RUNNING} state. The set of legal
...
public interface IService {
  ...
  /**
   * Waits for the {@link IService} to reach the {@linkplain State#RUNNING running state}.
   *
  ...
  /**
   * Waits for the {@link IService} to reach the {@linkplain State#RUNNING running state} for no more
   * than the given time.
   *
  ...
  /**
   * Waits for the {@link IService} to reach the {@linkplain State#TERMINATED terminated state}.
   *
  ...
  /**
   * Waits for the {@link IService} to reach a terminal state (either {@link IService.State#TERMINATED
   * terminated} or {@link IService.State#FAILED failed}) for no more than the given time.
   *
   * @param timeout the maximum time to wait
   * @throws TimeoutException if the service has not reached the given state within the deadline
   * @throws IllegalStateException if the service {@linkplain State#FAILED fails}.
  ...
  /**
   * A listener for the various state changes that a {@link IService} goes through in its lifecycle.
   *
  ...
  abstract class Listener {
     ...
     * State#STARTING STARTING}. This occurs when {@link IService#startAsync} is called the first
     * time.
     */
     ...
     * State#RUNNING RUNNING}. This occurs when {@link IService#stopAsync} is called.
     *
