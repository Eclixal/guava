 ...
 * {@link Futures#transformAsync(IListenableFuture, IAsyncFunction, Executor)}.
 *
 * @author Chris Povirk
 * @since 11.0
 */
@GwtCompatible
@FunctionalInterface
public interface IAsyncFunction<I, O> {
  /**
   ...
   */
  IListenableFuture<O> apply(@Nullable I input) throws Exception;
}
