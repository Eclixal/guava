 ...
 * methods. This class uses a single thread to execute the service; consider {@link AbstractIService}
 ...
 */
@GwtIncompatible
public abstract class AbstractExecutionThreadIService implements IService {
  private static final Logger logger =
      Logger.getLogger(AbstractExecutionThreadIService.class.getName());

  /* use AbstractService for state management */
  private final IService delegate =
      new AbstractIService() {
              ...
              new Runnable() {
                ...
                public void run() {
                  try {
                    ...
                    if (isRunning()) {
                      try {
                        AbstractExecutionThreadIService.this.run();
                      } catch (Throwable t) {
                        try {
                          shutDown();
        ...
        public String toString() {
          return AbstractExecutionThreadIService.this.toString();
        }
      };

  /** Constructor for use by subclasses. */
  protected AbstractExecutionThreadIService() {}
  ...
  /**
   * Returns the name of this service. {@link AbstractExecutionThreadIService} may include the name
   * in debugging output.
   *
