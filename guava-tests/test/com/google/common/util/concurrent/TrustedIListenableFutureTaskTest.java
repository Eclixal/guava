...
/** Test case for {@link TrustedIListenableFutureTask}. */
@GwtCompatible(emulated = true)
public class TrustedIListenableFutureTaskTest extends TestCase {

  public void testSuccessful() throws Exception {
    TrustedIListenableFutureTask<Integer> task = TrustedIListenableFutureTask.create(returning(2));
  ...
  public void testFailed() throws Exception {
    ...
    TrustedIListenableFutureTask<Integer> task =
  ...
  public void testCancel_interrupted() throws Exception {
    ...
    final TrustedIListenableFutureTask<Integer> task =
        TrustedIListenableFutureTask.create(
            new Callable<Integer>() {
              @Override
              public Integer call() throws Exception {
  ...
  public void testToString() throws Exception {
    final CountDownLatch enterLatch = new CountDownLatch(1);
    final CountDownLatch exitLatch = new CountDownLatch(1);
    final TrustedIListenableFutureTask<Void> task =
        TrustedIListenableFutureTask.create(
            new Callable<Void>() {
              @Override
