 ...
 * Futures#transform(IListenableFuture, com.google.common.base.Function, Executor)
 ...
 *       service to a {@link IListeningExecutorService}, usually by calling {@link
 ...
 *       create a {@link SettableFutureI} instead. (If your needs are more complex, you may prefer
 *       {@link AbstractFutureI}.)
 * </ul>
 *
 * <p><b>Test doubles</b>: If you need a {@code ListenableFuture} for your test, try a {@link
 * SettableFutureI} or one of the methods in the {@link Futures#immediateFuture Futures.immediate*}
 ...
 * with the methods in {@link Futures} or, if necessary, to extend {@link AbstractFutureI}.
 *
