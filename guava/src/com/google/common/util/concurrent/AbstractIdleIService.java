 ...
 */
@GwtIncompatible
public abstract class AbstractIdleIService implements IService {
  ...
  private final IService delegate = new DelegateIService();

  @WeakOuter
  private final class DelegateIService extends AbstractIService {
    @Override
    ...
    public String toString() {
      return AbstractIdleIService.this.toString();
    }
  }

  /** Constructor for use by subclasses. */
  protected AbstractIdleIService() {}
  ...
  /**
   * Returns the name of this service. {@link AbstractIdleIService} may include the name in debugging
   * output.
   *
   * @since 14.0
   */
