...
/**
 * Tests for {@link AbstractIdleIService}.
 *
 * @author Chris Nokleberg
 * @author Ben Yu
 */
public class AbstractIdleIServiceTest extends TestCase {
  ...
  public static class FunctionalTest extends TestCase {
    ...
    private static class DefaultIService extends AbstractIdleIService {
      @Override
    ...
    public void testServiceStartStop() throws Exception {
      AbstractIdleIService service = new DefaultIService();
  ...
  public void testStart() {
    ...
    assertEquals(IService.State.RUNNING, service.state());
    assertThat(service.transitionStates).containsExactly(IService.State.STARTING);
  }

  public void testStart_failed() {
    final Exception exception = new Exception("deliberate");
    TestIService service =
        new TestIService() {
          @Override
          protected void startUp() throws Exception {
            super.startUp();
  ...
  public void testStop_afterStart() {
    ...
    assertThat(service.transitionStates)
        .containsExactly(IService.State.STARTING, IService.State.STOPPING)
        .inOrder();
  }
  ...
  public void testServiceToString() {
    AbstractIdleIService service = new TestIService();
  ...
  private static class TestIService extends AbstractIdleIService {
    int startUpCalled = 0;
