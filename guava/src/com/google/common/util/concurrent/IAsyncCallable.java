 ...
 * Futures.FutureCombiner#callAsync(IAsyncCallable, java.util.concurrent.Executor)}.
 *
 * <p>Much like {@link java.util.concurrent.Callable}, but returning a {@link IListenableFuture}
 * result.
 *
 * @since 20.0
 */
...
public interface IAsyncCallable<V> {
   ...
   * IListenableFuture}.
   */
  IListenableFuture<V> call() throws Exception;
}
