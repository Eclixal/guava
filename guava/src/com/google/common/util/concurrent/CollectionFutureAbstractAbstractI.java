...
abstract class CollectionFutureAbstractAbstractI<V, C> extends AbstractAbstractAggregateFutureI<V, C> {
  /*
  ...
  CollectionFutureAbstractAbstractI(
      ImmutableCollection<? extends IListenableFuture<? extends V>> futures,
  ...
  static final class ListFutureAbstractAbstractI<V> extends CollectionFutureAbstractAbstractI<V, List<V>> {
    ListFutureAbstractAbstractI(
        ImmutableCollection<? extends IListenableFuture<? extends V>> futures,
        boolean allMustSucceed) {
