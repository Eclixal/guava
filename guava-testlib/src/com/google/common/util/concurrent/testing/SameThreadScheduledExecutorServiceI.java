 ...
 */
@GwtIncompatible
class SameThreadScheduledExecutorServiceI extends AbstractExecutorService
    implements IListeningScheduledExecutorService {

  private final IListeningExecutorService delegate = newDirectExecutorService();
  ...
  @Override
  public <T> IListenableFuture<T> submit(Runnable task, T result) {
    Preconditions.checkNotNull(task, "task must not be null!");
  ...
  public <V> IListenableScheduledFuture<V> schedule(
    ...
    Preconditions.checkNotNull(unit, "unit must not be null!");
    IListenableFuture<V> delegateFuture = submit(callable);
    return new ImmediateScheduledFutureI<V>(delegateFuture);
  }
  ...
  private static class ImmediateScheduledFutureI<V> extends ForwardingIListenableFuture.SimpleForwardingIListenableFuture<V>
    ...
    protected ImmediateScheduledFutureI(IListenableFuture<V> future) {
      super(future);
    }
