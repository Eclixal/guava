...
@GwtCompatible
abstract class AbstractTransformFutureI<I, O, F, T> extends FluentFuture.TrustedFutureI<O>
    implements Runnable {
  static <I, O> IListenableFuture<O> create(
      IListenableFuture<I> input,
      IAsyncFunction<? super I, ? extends O> function,
      Executor executor) {
    checkNotNull(executor);
    AsyncTransformFutureI<I, O> output = new AsyncTransformFutureI<>(input, function);
  ...
  static <I, O> IListenableFuture<O> create(
    ...
    TransformFutureI<I, O> output = new TransformFutureI<>(input, function);
    input.addListener(output, rejectionPropagatingExecutor(executor, output));
    return output;
  }
   ...
   */
  @Nullable IListenableFuture<? extends I> inputFuture;
  @Nullable F function;

  AbstractTransformFutureI(IListenableFuture<? extends I> inputFuture, F function) {
  ...
  public final void run() {
    IListenableFuture<? extends I> localInputFuture = inputFuture;
    ...
    if (localInputFuture.isCancelled()) {
      ...
      boolean unused =
          setFuture((IListenableFuture<O>) localInputFuture); // Respects cancellation cause setting
      return;
    }
  ...
  /**
   * An {@link AbstractTransformFutureI} that delegates to an {@link IAsyncFunction} and {@link
   * #setFuture(IListenableFuture)}.
   */
  private static final class AsyncTransformFutureI<I, O>
      extends AbstractTransformFutureI<
                I, O, IAsyncFunction<? super I, ? extends O>, IListenableFuture<? extends O>> {
    AsyncTransformFutureI(
            IListenableFuture<? extends I> inputFuture, IAsyncFunction<? super I, ? extends O> function) {
      super(inputFuture, function);
    }

    @Override
    IListenableFuture<? extends O> doTransform(
            IAsyncFunction<? super I, ? extends O> function, @Nullable I input) throws Exception {
      IListenableFuture<? extends O> outputFuture = function.apply(input);
      checkNotNull(
          outputFuture,
    ...
    @Override
    void setResult(IListenableFuture<? extends O> result) {
      setFuture(result);
    }
  }

  /**
   * An {@link AbstractTransformFutureI} that delegates to a {@link Function} and {@link
   * #set(Object)}.
   */
  private static final class TransformFutureI<I, O>
      extends AbstractTransformFutureI<I, O, Function<? super I, ? extends O>, O> {
    TransformFutureI(
            IListenableFuture<? extends I> inputFuture, Function<? super I, ? extends O> function) {
      super(inputFuture, function);
    }
