...
/**
 * Abstract test case parent for anything implementing {@link IListenableFuture}. Tests the two get
...
@Beta
@GwtIncompatible
public abstract class AbstractIListenableFutureTest extends TestCase {

  protected CountDownLatch latch;
  protected IListenableFuture<Boolean> future;
  ...
  protected abstract <V> IListenableFuture<V> createListenableFuture(
