 ...
 * </ul>
 *
 * To force selection of our fallback strategies we load {@link AbstractAggregateFutureStateI} (and all of
...
public class AbstractAbstractAggregateFutureStateFallbackAtomicHelperTest extends TestCase {
  ...
  public static TestSuite suite() {
    ...
    TestSuite suite = new TestSuite(AbstractAbstractAggregateFutureStateFallbackAtomicHelperTest.class.getName());
      ...
      if (Modifier.isPublic(method.getModifiers()) && method.getName().startsWith("test")) {
        suite.addTest(
            TestSuite.createTest(
                AbstractAbstractAggregateFutureStateFallbackAtomicHelperTest.class, method.getName()));
      }
    }
    return suite;
  }
  ...
  private void checkHelperVersion(ClassLoader classLoader, String expectedHelperClassName)
    ...
    Class<?> abstractFutureClass = classLoader.loadClass(AbstractAggregateFutureStateI.class.getName());
  ...
  private static ClassLoader getClassLoader(final Set<String> blocklist) {
    ...
    ClassLoader classLoader = AbstractAbstractAggregateFutureStateFallbackAtomicHelperTest.class.getClassLoader();
