...
/**
 * Superinterface of {@link IServiceManager} to introduce a bridge method for {@code
 ...
 */
@GwtIncompatible
interface IServiceManagerBridge {
  ImmutableMultimap<State, IService> servicesByState();
}
