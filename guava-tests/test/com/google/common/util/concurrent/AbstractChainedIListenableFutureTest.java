 ...
 */
public abstract class AbstractChainedIListenableFutureTest<T> extends TestCase {
  ...
  protected SettableFutureI<Integer> inputFuture;
  protected IListenableFuture<T> resultFuture;
  ...
  protected void setUp() throws Exception {
    ...
    inputFuture = SettableFutureI.create();
   ...
   * cases.
   */
  protected abstract IListenableFuture<T> buildChainingFuture(IListenableFuture<Integer> inputFuture);
