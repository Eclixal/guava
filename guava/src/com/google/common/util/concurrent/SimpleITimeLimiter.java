...
@Beta
@GwtIncompatible
public final class SimpleITimeLimiter implements ITimeLimiter {

  private final ExecutorService executor;

  private SimpleITimeLimiter(ExecutorService executor) {
   ...
   * @since 22.0
   */
  public static SimpleITimeLimiter create(ExecutorService executor) {
    return new SimpleITimeLimiter(executor);
  }
